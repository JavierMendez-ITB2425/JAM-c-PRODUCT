...
1. [Justificación y Objetivos del Proyecto](#1-justificación-y-objetivos-del-proyecto)
2. [Topología y Arquitectura Cloud (AWS VPC)](#2-topología-y-arquitectura-cloud-aws-vpc)
3. [Desglose Técnico de los Nodos](#3-desglose-técnico-de-los-nodos)
   - [Nodo 1: Firewall Perimetral y Control de Acceso](#nodo-1-firewall-perimetral-y-control-de-acceso)
   - [Nodo 2: Balanceador de Carga / Reverse Proxy](#nodo-2-balanceador-de-carga--reverse-proxy)
   - [Nodos 3 y 4: Clúster de Streaming HLS](#nodos-3-y-4-clúster-de-streaming-hls)
   - [Nodo 5: CiberSOC y Telemetría](#nodo-5-cibersoc-y-telemetría)
4. [Flujo de Integración y Respuesta Activa](#4-flujo-de-integración-y-respuesta-activa)
5. [Pruebas de Carga y Simulación](#5-pruebas-de-carga-y-simulación)
